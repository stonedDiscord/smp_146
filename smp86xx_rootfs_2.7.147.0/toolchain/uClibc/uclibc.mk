...
UCLIBC_PATCH_LIST := $(wildcard $(BASE_DIR)/toolchain/uClibc/*.patch)
...
$(UCLIBC_DIR)/.configured: $(UCLIBC_DIR)/.patched $(LINUX_HEADERS_DIR)/.configured
...
$(TARGET_DIR)/usr/bin/ldd: $(UCLIBC_DIR)/.configured
