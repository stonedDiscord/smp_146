...
$(TARGET_DIR)/lib/libthread_db-0.9.27.so: $(SMP86XX_TOOLCHAIN_PATH)/lib/libthread_db-0.9.27.so
	cp $< $@

$(TARGET_DIR)/lib/libthread_db.so.1: $(TARGET_DIR)/lib/libthread_db-0.9.27.so
	ln -s $(<F) $@
	
$(TARGET_DIR)/lib/libthread_db.so: $(TARGET_DIR)/lib/libthread_db.so.1
	ln -s $(<F) $@

gdbserver: $(TARGET_DIR)/usr/bin/gdbserver $(TARGET_DIR)/lib/libthread_db.so
